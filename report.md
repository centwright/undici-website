...
- Public artifact: the generated [`llms.txt`](https://undici-website-git-fork-centwright-codex-sourcey-llms-openjs.vercel.app/llms.txt) is served by the OpenJS Foundation's Vercel project for upstream PR #18. The live OpenJS-controlled deployment is byte-identical to the sealed Sourcey-generated artifact.
