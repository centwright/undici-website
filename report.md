...
- Public artifact: the generated [`llms.txt`](https://centwright.github.io/undici-website/llms.txt) is served from the fork's durable GitHub Pages site. It is byte-identical to the sealed Sourcey-generated artifact; the `gh-pages` branch is dedicated as the published surface rather than a throwaway evidence URL.
